...
/***/ (function(module, exports) {
	...
	AFRAME.registerComponent('environment', {
	  schema: {
	    preset: {default: 'default', oneOf: ['none', 'snow', 'default', 'contact', 'egypt', 'checkerboard', 'forest', 'goaland', 'yavapai', 'goldmine', 'arches', 'threetowers', 'poison', 'tron', 'japan', 'dream', 'volcano', 'starry', 'osiris']},
	  ...
	  presets: {
	    'none' : {},
	    'snow' : {seed: 82, skyType: 'gradient', skyColor: '#cef', horizonColor: '#8ac', lighting: 'distant', lightPosition: { x: -0.11, y: 1, z: 0.33}, fog: 0.2, flatShading: false, playArea: 1, ground: 'hills', groundYScale: 6, groundTexture: 'walkernoise', groundColor: '#eee', groundColor2: '#ccc', dressing: 'none', dressingAmount: 10, dressingColor: '#795449', dressingScale: 1, dressingVariance: { x: 0, y: 0, z: 0}, dressingUniformScale: true, dressingOnPlayArea: 0, grid: 'none', gridColor: '#ccc', shadow: false},
